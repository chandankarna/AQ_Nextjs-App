...
const Career = () => {
  ...
  return (
    <>
                    ...
                    <div className="col-lg-10 text-center col-12">
                        ...
                        <Animated variant="fadeUp" delay="0.2" >
                            <p className="para mt-3">
                                ...
                                <br /><br />
                                If you seek challenges, excel in a dynamic setting, and possess a vision that extends conventional boundaries, <br /> <br />
                                <Link href="#jobs" className='center main-btn'><span>Join us!</span></Link>
                            </p>
                        </Animated>
                    </div>
                </div>
        ...
        <section className="sec grey-sec" id="jobs">
            <div className="container">
                <div className="row">
